...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasuresRepository unitOfMeasuresRepository) {
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> gramUomOptional=unitOfMeasuresRepository.findByDescription("Gram");
        if(!gramUomOptional.isPresent()){
            throw new RuntimeException("Beklenen Ölçü birimi bulunamamıştır.");
        }

        Optional<UnitOfMeasure> cayKasigiUom = unitOfMeasuresRepository.findByDescription("Cay Kaşığı");
        if(!cayKasigiUom.isPresent()){
            throw new RuntimeException("Beklenen Ölçü birimi bulunamamıştır.");
        }
        Optional<UnitOfMeasure> yemekKasigiUom = unitOfMeasuresRepository.findByDescription("Yemek Kaşığı");
        if(!yemekKasigiUom.isPresent()){
            throw new RuntimeException("Beklenen Ölçü birimi bulunamamıştır.");
        }
        Optional<UnitOfMeasure> kepceUom = unitOfMeasuresRepository.findByDescription("Kepçe");

        if(!kepceUom.isPresent()){
            throw new RuntimeException("Beklenen Ölçü birimi bulunamamıştır.");
        }
        Optional<UnitOfMeasure> suBardagiUom = unitOfMeasuresRepository.findByDescription("Su Bardağı");
        ...
        guacNotes.setRescipeNote( "For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setRescipeNote("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
